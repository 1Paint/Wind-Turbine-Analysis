...
class Solutions(object):
    ...
    def __init__(self, constants):
        ...
        self.mass = [None]*length
        self.sf_yield = [None]*length
        self.sf_fatigue = [None]*length
        self.max_twists = [None]*length
        self.life = [None]*length
...
class EditWindow(QtGui.QDialog):
    ...
    # Update the plot in the main window when 'Update' is pressed.
    def update(self):
...
class AppWindow(QtGui.QMainWindow):
    ...
    def update_solution(self):
        """Plot shaft sections and related info to the application window."""
